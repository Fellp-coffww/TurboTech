...
import org.com.br.Infra.Interfaces.IItemServico;

import java.sql.*;
import java.util.ArrayList;
import java.util.List;

public class ItemServicoRepository implements IItemServico {

    private Connection connection = null;
    public ItemServicoRepository()throws Exception{
